...
RUN mkdir /app; cd /app; wget https://github.com/samldd/my-workforce-frontend/releases/download/v$(cat /package.json | grep version | head -n 1 | awk -F: '{ print $2 }' | sed 's/[ ",]//g')/dist.zip
